...
const ProgramCard = (props: Props) => {
  return (
    <div className="relative bg-white border border-gray-300 flex flex-col justify-around w-[332px] h-[396px] rounded-lg p-4 font-poppins shadow-xl">
      ...
      <button className="absolute -bottom-5  w-[50%] py-2 rounded-lg left-20 bg-[#008080] text-white font-bolf ">
        View
      </button>
    </div>
  );
