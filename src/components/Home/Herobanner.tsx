...
const Herobanner = (props: Props) => {
  return (
    <div className="relative ">
      ...
      <div className="w-[50%] z-50 h-[550px] mx-auto flex flex-col py-24 gap-8 text-white justify-center items-center relative">
        <h1 className="text-5xl font-bold text-center text-white opacity-100">
          Pseudo Code
        </h1>
        ...
        />
        <button className="flex justify-center px-24 font-bold rounded-lg py-3 bg-[#008080] items-center gap-2">
          <Search />
          Search
        </button>
      </div>
