...
const HomeCard = ({ image, title, profession }: Props) => {
  return (
    <div className="relative bg-white  font-poppins flex flex-col  justify-center  gap-4 p-4 rounded-xl hover:shadow-xl hover:transition-all hover:duration-300 border">
